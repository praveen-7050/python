...
#process of providing parent class property into child class
...
#  hybrid inheritance
# combination of one or more inheritance
...
#anything which takes multiple form polymorphism
...
#encapsulation
#wrapping up a data along with its data handler method
...
#abstraction:
#hiding the implementation providing the functionalities to the user
